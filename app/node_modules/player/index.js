...
Player.prototype.setDirection = function (a, b) {
	if (b !== undefined) {
...
Player.prototype.queueTurn = function (a, b) {
	let fn = function () {
...
Player.prototype.move = function (dx, dy, callback, queue = false) {
...
Player.prototype.queueMove = function (dx, dy, callback) {
	let fn = function () {
